...
5. Write the specification to SPEC_FILE using the template structure, replacing placeholders with concrete details derived from the feature description (arguments) while preserving section order and headings. **IMPORTANT**: All content MUST be written in Traditional Chinese (zh-TW) per Constitution Principle V.
